...
void bubbleSort(NODE first)
{
    ...
    do
    {
        ...
        while (cur->link != prev)
        {
        	if((cur->info[0] < 91 && cur->link->info[0] < 91 )|| (cur->info[0] > 96 && cur->link->info[0] > 96))
		     {
		        if (cur->info[0] > cur->link->info[0])
		        {
		            swap(cur, cur->link);
		            swapped = 1;
		        }
		     }
		     else if(cur->info[0] < 91 && cur->link->info[0] > 96)
            	     {
		        if (cur->info[0] + 32 > cur->link->info[0])
		        {
		            swap(cur, cur->link);
		            swapped = 1;
		        }
		     ...
		     {
		        if (cur->info[0] > cur->link->info[0] + 32)
		        {
		            swap(cur, cur->link);
		            swapped = 1;
		        }
